//********importing the rerquired packages********
...
//********Taking the dimension of the screen********
...
const DetailedScreen=({image,description,author,publishedAt,content})=>{
  ...
  //*********function for opening the socila media share menu********
  ...
  const myCustomeShare=async()=>{
   ...
   //************checking for the rquired permissions************
  ...
  const checkPermission = async () => {                                        
   ...
   //**********downloading the image from the URL given by the API************
  ...
  //***********as per the platform(ios or Android) rendering the components************
...
//***********maping states from Redux to the props************
